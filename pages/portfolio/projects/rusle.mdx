...
The analysisi was initially done in ArcGIS Pro and then redone with R using several packages like `sf`, `terra`, `tmap` for spatial data analysis and visualization.
