...
<video width="100%" height="240" controls preload="metadata" loop>
  <source src="/geovis-portfolio/portfolio/projects/flood/2D-flood-animation.mp4" type="video/mp4" />
  {/* <track
...
### 3D Animation
<video width="100%" height="240" controls preload="metadata" loop>
  <source src="/geovis-portfolio/portfolio/projects/flood/3D-flood-animation.mp4" type="video/mp4" />
  {/* <track
    src="/path/to/captions.vtt"
    kind="subtitles"
    srcLang="en"
